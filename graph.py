...
class Vertex(object):
    ...
    def __repr__(self):
        ...
        """
        return 'Vertex(label={}, #incident={}, #colornum={})'.format(self.label, len(self._incidence), self.colornum)
...
class Graph(object):
    ...
    def __add__(self, other: "Graph") -> "Graph":
        ...
        e = self.edges
        e.extend(other.edges)
        for i in range(0, len(e)):
            G.add_edge(Edge(dict[e[i].tail], dict[e[i].head]))
        return G
